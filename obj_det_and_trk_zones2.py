...
def parse_opt():
    ...
    parser.add_argument('--conf-thres-per-class', nargs='+', type=float, default=None, help='list of confidence thresholds, one for each class (default: [0.2]). Example usage: --conf-thres-2 0.5 0.6 0.3')
